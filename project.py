...
def gconnect():
    ...
    if result['issued_to'] != CLIENT_ID:
        response = make-response(json.dumps("Token's client ID does not math app's."), 401)
...
def fbconnect():
    ...
    url = 'https://graph.facebook.com/oauth/access-token?grant_type=fb_exchange_token' \
